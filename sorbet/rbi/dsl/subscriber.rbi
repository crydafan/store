...
class Subscriber
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        records: T.any(::Subscriber, Integer, String, T::Enumerable[T.any(::Subscriber, Integer, String, T::Enumerable[::Subscriber])])
      ).returns(Integer)
    end
    ...
    sig { params(args: T.untyped).returns(T::Array[::Subscriber]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Subscriber]])
    end
